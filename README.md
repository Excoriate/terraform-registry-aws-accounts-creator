...
| `aws-iam-policy-attacher`   | Stable ✅ | Module that wraps the attachment functionality. It's intended to be used in order to attach multiple IAM policies to several IAM roles. |
